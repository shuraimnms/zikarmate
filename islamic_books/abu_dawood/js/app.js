...
// Function to perform instant search
    ...
    if (filteredHadiths.length === 0) {
        ...
        filteredHadiths.forEach(hadith => {
            ...
            resultItem.innerHTML = `
                ...
                ${hadith.english ? `<p class="hadith-english"><strong>${hadith.english.narrator}:</strong> ${hadith.english.text}</p>` : ''}
            `;
...
document.getElementById('search-bar').addEventListener('input', searchHadith);
